package cn.edu.seu.alumni_background.log.aspect;

import cn.edu.seu.alumni_background.util.WebUtil;
...
public class LogAspect {
    ...
    @Pointcut("@within(cn.edu.seu.alumni_background.log.annotation.LogController)")
    public void logType() {}
